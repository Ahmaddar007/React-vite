...
function Navbar() {
  return (
    <div className="fixed z-[999] w-full px-6 sm:px-10 md:px-16 lg:px-20 py-4 md:py-6 lg:py-8 flex justify-between items-center">
      {/* Logo */}
      <div className="logo">
        <svg
          width="72"
          ...
          className="w-16 sm:w-20 md:w-[72px] h-auto"
        >
          <path
        ...
        {["services", "about Us", "our Work", "insights", "contact"].map(
          (item, index) => (
            <a
              key={index}
              href="#"
              className={`text-sm sm:text-base font-medium capitalize hover:text-gray-600 transition ${
                index === 4 ? "ml-0 lg:ml-32" : ""
              }`}
            >
              {item}
            </a>
