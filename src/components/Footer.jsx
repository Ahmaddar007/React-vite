...
function Footer() {
  return (
    <div className="w-full min-h-screen bg-zinc-900 p-4 sm:p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row gap-6 sm:gap-8 overflow-x-hidden">
      {/* Left Section */}
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-between">
        <div className="headings">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold uppercase leading-none">
            Eye-
          </h1>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold uppercase leading-none">
            Opening
        ...
        <div className="mt-6 sm:mt-8">
          <svg
            ...
            className="text-white max-w-[56px] sm:max-w-[64px] md:max-w-[72px]"
          >
            <path
      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
          <a
            className="block text-sm sm:text-base md:text-lg font-light hover:underline"
            href=""
          >
            Facebook
          </a>
