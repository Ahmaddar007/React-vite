...
function Footer() {
  return (
    <div className="w-full h-[500px] bg-white p-4 sm:p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row gap-6 sm:gap-8 overflow-x-hidden">
      {/* Left Section */}
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-between">
        ...
        <div className="mt-6 sm:mt-8">
          <svg
            ...
            className="text-black max-w-[56px] sm:max-w-[64px] md:max-w-[72px]"
          >
            <path
